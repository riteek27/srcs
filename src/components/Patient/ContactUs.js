                            ...
                            <div class="contact_info_container d-flex flex-lg-row flex-column justify-content-between align-items-between">
                                ...
                                <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                                    ...
                                    <div class="contact_info_content">
                                        ...
                                        <div class="contact_info_text">+91 9587 452 361</div>
                                    </div>
                                </div>
                                ...
                                <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                                    ...
                                    <div class="contact_info_content">
                                        ...
                                        <div class="contact_info_text">contactus@careexpert.com</div>
                                    </div>
                                </div>
                                ...
                                <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                                    ...
                                    <div class="contact_info_content">
                                        ...
                                        <div class="contact_info_text">Care Expert Hospitals,Survey No.1/2/3,1A,Wadgaon Sheri,Pune,Maharashtra</div>
                                    </div>
                                </div>
