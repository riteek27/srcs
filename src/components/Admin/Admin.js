        ...
        <Drawer variant="permanent" open={open}>
          ...
          <List component="nav">
            ...
            <Button>
              ...
              <PeopleIcon />
                <ListContent>Patients</ListContent>
              </Link>
            </Button>
            <hr />
            <Button>
              ...
              <PeopleIcon />
                <ListContent>Doctors</ListContent>
              </Link>
            </Button>
            <hr />
            <Button>
              <Link to='/admin/appointments'>
                <BookOnlineIcon />
                <ListContent>Appointments</ListContent>
              </Link>
            </Button>
            <hr />
            <Button>
              <Link to='/admin/complaints'>
                ...
                <ListContent>Complaints</ListContent>
              </Link>
              <Routes>
                <Route path='/admin/patients' element={<Patient />}></Route>
